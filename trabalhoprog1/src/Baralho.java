    ...
    while(true){
            {
                ...
                System.out.printf("Bem vindo, digite 4 para criar um baralho e 5 para embaralha-lo\n");
                /*//adicionando cartas
                criarBaralho(lista);
                ...
                System.out.printf("insira: 1 para pescar cartas\n        2 para jogar blackjack\n        3 para imprimir o baralho\n        4 para deletar o baralho e criar um novo\n        5 para embaralhar o baralho novo\n");
                ...
                if(parar == 0)
                    ...
                    else
                    {
                        ...
                        if( escolha == 3)
                        {
                            ...
                            System.out.printf("");
                            System.out.printf("numero de cartas: %d", lista.size());
                            ...
                            if(escolha == 4)
                            {
                                ...
                                lista.clear();
                                criarBaralho(lista);
                                System.out.printf("baralho recirada com sucesso");
                            }
                            else
                            {
                                if(escolha == 5)
